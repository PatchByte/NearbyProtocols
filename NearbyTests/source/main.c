...
int main()
{
    ...
    struct nearby_medium_advertisement advertisement_serialized = {};

    {
        ...
        if (nearby_medium_advertisement_deserialize(&advertisement_serialized, &test_data_buffer) == false)
        {
        ...
        printf(" Version: %s\n", nearby_medium_advertisement_version_to_string(advertisement_serialized.version));
        ...
        printf(" Re-Serialized size required: %li\n", nearby_medium_advertisement_serialize_get_required_data_length(&advertisement_serialized));
    }

    nearby_medium_advertisement_deserialize_cleanup(&advertisement_serialized);
